...
import { a9 as getBootstrapData, m as message, c as createSvgIcon, $ as getInputFieldClassNames, ai as useField, aj as Field, ba as useUserTimezone, a as useIsMobileMediaQuery, az as useSelectedLocale, bb as useDateFormatter, I as IconButton, u as useSettings, af as DateFormatPresets, bc as shallowEqual, W as List, X as ListItem, T as Trans, g as useDialogContext, p as DialogFooter, B as Button, h as Dialog, j as DialogBody, z as apiClient, e as useTrans, S as SelectForwardRef, d as Item, t as opacityAnimation, O as Tooltip, q as Skeleton, L as Chip, bd as useListbox, be as Listbox, bf as Popover, a3 as ProgressCircle, K as KeyboardArrowDownIcon, bg as useListboxKeyboardNavigation, b9 as createEventHandler, D as DialogTrigger, k as Form, ag as prettyBytes, P as ProgressBar, bh as useFileUploadStore, a0 as MixedText, bi as ErrorIcon, aC as WarningIcon, bj as CheckCircleIcon, r as CloseIcon, y as showHttpErrorToast, aE as UploadInputType, aF as Disk, x as toast, bk as validateUpload, bl as openUploadWindow, R as FormImageSelector, f as FormTextField, w as queryClient, H as onFormQueryError, a4 as useNavigate, a1 as FileUploadProvider, au as PageStatus, i as DialogHeader, E as IllustratedMessage, G as SvgImage, A as ConfirmationDialog, a7 as LinkStyle, n as TextField, aO as useAuth, aN as useIsDarkMode, N as Navbar, bm as Footer, M as FormattedDate, aQ as getArtistLink, aU as useThemeSelector, aV as lazyLoader, as as SmallArtistImage, ax as UserProfileLink, at as ArtistLink, v as StaticPageTitle } from "../server-entry.mjs";
import { useLocation, Navigate, Link, useSearchParams, useParams } from "react-router-dom";
import { K as KeyboardArrowLeftIcon, a as KeyboardArrowRightIcon, Z as useIsTabletMediaQuery, S as Switch, A as Avatar, C as ChipList, $ as generateWaveformData, G as GENRE_MODEL, k as FormattedDuration, v as getTrackLink, X as useTrack, E as useTrackPermissions, w as getAlbumLink, D as DragPreview, b as AddIcon, u as useSortable, V as useAlbum, y as useAlbumPermissions, L as usePrimaryArtistForCurrentUser, o as ALBUM_MODEL, l as AlbumImage, i as TrackImage, z as ArtistLinks, s as ShareMediaButtons, a0 as useDroppable, O as useSortableTableData, T as Table, n as AlbumLink, F as FormattedNumber, B as useDeleteAlbum, c as FormSwitch, d as Tabs, e as TabList, f as Tab, g as TabPanels, h as TabPanel, Y as ProfileLinksForm, R as useArtist, x as useArtistPermissions, t as themeValueToHex, P as PlayArrowFilledIcon, U as UserAvatar, j as TrackLink } from "./play-arrow-filled-d45cea03.mjs";
...
const musicImage = "/assets/music-7a11c2fe.svg";
...
function UploadedMediaPreview({ media }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-28 border rounded bg-paper p-20 my-20 mx-auto w-780 max-w-full", children: [
...
const lightBgImage = "/assets/light-bg-8c37cb47.svg";
const darkBgImage = "/assets/dark-bg-38ecc414.svg";
function BackstageLayout({ children, ...domProps }) {
  const isDarkMode = useIsDarkMode();
  return /* @__PURE__ */ jsxs("div", { className: "h-screen flex flex-col", ...domProps, children: [
    /* @__PURE__ */ jsx(Navbar, { className: "flex-shrink-0", color: "bg", darkModeColor: "bg" }),
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto p-14 md:p-24 min-h-full flex flex-col", children: [
...
function UploadPanel({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pt-40", children: [
    /* @__PURE__ */ jsxs("div", { className: "border rounded p-20 md:p-48 flex flex-col items-center max-w-580 mx-auto bg-paper", children: [
...
function BackstageInsightsLayout({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col", children: [
      !isNested && /* @__PURE__ */ jsx(Navbar, { className: "flex-shrink-0", color: "bg", darkModeColor: "bg" }),
      /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-auto bg-cover relative", children: /* @__PURE__ */ jsxs("div", { className: "min-h-full p-12 md:p-24 overflow-x-hidden max-w-[1600px] mx-auto flex flex-col", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
...
//# sourceMappingURL=backstage-track-insights-106425a1.mjs.map
