...
import { B as Button, T as Trans, t as opacityAnimation, a3 as ProgressCircle, aM as getFromLocalStorage, s as setInLocalStorage, w as queryClient, z as apiClient, aN as useIsDarkMode, I as IconButton, a4 as useNavigate, D as DialogTrigger, aO as useAuth, a9 as getBootstrapData, x as toast, m as message, y as showHttpErrorToast, g as useDialogContext, aP as openDialog, h as Dialog, j as DialogBody, aA as slugifyString, u as useSettings, e as useTrans, i as DialogHeader, p as DialogFooter, a as useIsMobileMediaQuery, n as TextField, as as SmallArtistImage, aQ as getArtistLink, at as ArtistLink, A as ConfirmationDialog, c as createSvgIcon, E as IllustratedMessage, q as Skeleton, J as CheckIcon, ax as UserProfileLink, aR as getUserProfileLink, O as Tooltip, aS as ContentGrid, aT as useIsMobileDevice, ay as FormattedRelativeTime, aU as useThemeSelector, L as Chip, aV as lazyLoader, aH as PageMetaTags, au as PageStatus, C as CustomMenu, P as ProgressBar, aW as useCustomMenu, aX as CustomMenuItem, d as Item, aY as MicIcon, aZ as PersonIcon, a_ as Badge, ab as MenuTrigger, ac as Menu, a$ as NavbarAuthMenu, K as KeyboardArrowDownIcon, ap as useMediaQuery, o as SearchIcon, aB as ComboBoxForwardRef, Z as Section, b0 as useListboxContext, N as Navbar, ao as isAbsoluteUrl, b1 as ArrowDropDownIcon, M as FormattedDate, b2 as useCookie, a6 as FullPageLoader, a1 as FileUploadProvider, b3 as ImageSelector, a8 as SiteConfigContext, a7 as LinkStyle, b4 as getSmallArtistImage, b5 as PageErrorMessage, v as StaticPageTitle, b6 as PlayableMediaGridSkeleton, H as onFormQueryError, U as useValueLists, k as Form, R as FormImageSelector, f as FormTextField, aL as NotFoundPage, aK as AuthRoute } from "../server-entry.mjs";
...
import { q as isCtrlOrShiftPressed, r as getTrackImageSrc, P as PlayArrowFilledIcon, a as KeyboardArrowRightIcon, b as AddIcon, d as Tabs, e as TabList, f as Tab, g as TabPanels, h as TabPanel, s as ShareMediaButtons, i as TrackImage, l as AlbumImage, v as getTrackLink, w as getAlbumLink, x as useArtistPermissions, y as useAlbumPermissions, n as AlbumLink, z as ArtistLinks, B as useDeleteAlbum, E as useTrackPermissions, j as TrackLink, G as GENRE_MODEL, o as ALBUM_MODEL, p as TableContext, T as Table, k as FormattedDuration, H as TableRow, A as Avatar, t as themeValueToHex, W as WAVE_WIDTH, I as WAVE_HEIGHT, F as FormattedNumber, J as ShareIcon, K as KeyboardArrowLeftIcon, L as usePrimaryArtistForCurrentUser, M as assignAlbumToTracks, N as AlbumIcon, O as useSortableTableData, Q as albumLayoutKey, R as useArtist, D as DragPreview, u as useSortable, U as UserAvatar, V as useAlbum, C as ChipList, X as useTrack, Y as ProfileLinksForm, Z as useIsTabletMediaQuery } from "./play-arrow-filled-d45cea03.mjs";
...
function LyricsDialog({ track }) {
  ...
  const { close } = useDialogContext();
  let content2;
  if ((_a2 = data == null ? void 0 : data.lyric) == null ? void 0 : _a2.text) {
    content2 = /* @__PURE__ */ jsx(
      m.div,
      {
        className: "text-lg w-full",
        ...opacityAnimation,
        dangerouslySetInnerHTML: { __html: ((_b2 = data == null ? void 0 : data.lyric) == null ? void 0 : _b2.text) || "" }
      },
      "lyrics"
    );
  } else if (isLoading) {
    content2 = /* @__PURE__ */ jsx(LyricSkeleton, {});
  } else {
    content2 = /* @__PURE__ */ jsx(
      IllustratedMessage,
      {
  ...
  return /* @__PURE__ */ jsxs(Dialog, { size: "fullscreenTakeover", children: [
    /* @__PURE__ */ jsx(DialogHeader, { closeButtonSize: "lg", children: /* @__PURE__ */ jsx("div", { className: "sr-only", children: /* @__PURE__ */ jsx(Trans, { message: "Lyrics" }) }) }),
    /* @__PURE__ */ jsxs(DialogBody, { className: "flex items-stretch gap-24 h-full", padding: "p-0", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden md:flex-[0.4_1_0%] md:flex items-center justify-end pl-40", children: /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(
          TrackImage,
          {
            track,
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-14 text-center text-xl", children: track.name }),
        /* @__PURE__ */ jsx("div", { className: "mt-4 text-center text-base text-muted", children: /* @__PURE__ */ jsx(
          ArtistLinks,
          {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-auto md:flex-[0.6_1_0%] stable-scrollbar overflow-y-auto text-center pl-14 pr-14 md:pl-0 md:pr-40 pb-40", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-full w-full max-w-580 mx-auto", children: /* @__PURE__ */ jsx(AnimatePresence, { children: content2 }) }) })
    ] })
  ] });
}
function LyricSkeleton() {
  return /* @__PURE__ */ jsx(m.div, { ...opacityAnimation, className: "w-full", children: [...new Array(8).keys()].map((key) => /* @__PURE__ */ jsx(Skeleton, { variant: "text", className: "mb-20" }, key)) }, "skeleton");
}
...
function LyricsButton() {
  ...
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "modal", children: [
    /* @__PURE__ */ jsx(Tooltip, { label: /* @__PURE__ */ jsx(Trans, { message: "Lyrics" }), children: /* @__PURE__ */ jsx(IconButton, { children: /* @__PURE__ */ jsx(MediaMicrophoneIcon, {}) }) }),
    /* @__PURE__ */ jsx(LyricsDialog, { track })
  ] });
}
...
const HlsProvider = React.lazy(
  () => import("./hls-provider-2a7eb41b.mjs")
);
const DashProvider = React.lazy(
  () => import("./dash-provider-f74a9c94.mjs")
);
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          ComboBoxForwardRef,
          {
            ...
            children: Object.entries((data == null ? void 0 : data.results) || {}).map(([groupName, results]) => /* @__PURE__ */ jsx(Section, { label: /* @__PURE__ */ jsx(Trans, { message: groupName }), children: results.map((result) => {
...
function SearchResults({ results }) {
  ...
  const tabNames = useMemo(() => {
    const names = ["tracks", "artists", "albums", "playlists", "users"].filter(
      (tabName2) => {
        var _a3;
        return (_a3 = results[tabName2]) == null ? void 0 : _a3.length;
      }
    );
    return ["all", ...names];
  }, [results]);
  ...
  return /* @__PURE__ */ jsxs(Tabs, { selectedTab, onTabChange: setSelectedTab, children: [
    /* @__PURE__ */ jsxs(TabList, { children: [
      ...
      ((_a2 = results.tracks) == null ? void 0 : _a2.length) ? /* @__PURE__ */ jsx(Tab, { elementType: Link, to: tabLink("tracks"), children: /* @__PURE__ */ jsx(Trans, { message: "Tracks" }) }) : null,
      ((_b2 = results.artists) == null ? void 0 : _b2.length) ? /* @__PURE__ */ jsx(Tab, { elementType: Link, to: tabLink("artists"), children: /* @__PURE__ */ jsx(Trans, { message: "Artists" }) }) : null,
      ((_c2 = results.albums) == null ? void 0 : _c2.length) ? /* @__PURE__ */ jsx(Tab, { elementType: Link, to: tabLink("albums"), children: /* @__PURE__ */ jsx(Trans, { message: "Albums" }) }) : null,
      ((_d2 = results.playlists) == null ? void 0 : _d2.length) ? /* @__PURE__ */ jsx(Tab, { elementType: Link, to: tabLink("playlists"), children: /* @__PURE__ */ jsx(Trans, { message: "Playlists" }) }) : null,
      ((_e = results.users) == null ? void 0 : _e.length) ? /* @__PURE__ */ jsx(Tab, { elementType: Link, to: tabLink("users"), children: /* @__PURE__ */ jsx(Trans, { message: "Profiles" }) }) : null
    ] }),
    /* @__PURE__ */ jsxs(TabPanels, { className: "pt-8", children: [
      /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(TopResultsPanel, { results }) }),
      ((_f = results.tracks) == null ? void 0 : _f.length) ? /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(TrackResults, { tracks: results.tracks }) }) : null,
      ((_g = results.artists) == null ? void 0 : _g.length) ? /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(ArtistResults, { artists: results.artists }) }) : null,
      ((_h = results.albums) == null ? void 0 : _h.length) ? /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(AlbumResults, { albums: results.albums }) }) : null,
      ((_i = results.playlists) == null ? void 0 : _i.length) ? /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(PlaylistResults, { playlists: results.playlists }) }) : null,
      ((_j = results.users) == null ? void 0 : _j.length) ? /* @__PURE__ */ jsx(TabPanel, { children: /* @__PURE__ */ jsx(ProfileResults, { users: results.users }) }) : null
    ] })
  ] });
}
function TopResultsPanel({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    (tracks == null ? void 0 : tracks.length) ? /* @__PURE__ */ jsx(TrackResults, { tracks: tracks.slice(0, 5), showMore: true }) : null,
    (artists == null ? void 0 : artists.length) ? /* @__PURE__ */ jsx(ArtistResults, { artists: artists.slice(0, 5), showMore: true }) : null,
    (albums == null ? void 0 : albums.length) ? /* @__PURE__ */ jsx(AlbumResults, { albums: albums.slice(0, 5), showMore: true }) : null,
    (playlists == null ? void 0 : playlists.length) ? /* @__PURE__ */ jsx(PlaylistResults, { playlists: playlists.slice(0, 5), showMore: true }) : null,
    (users == null ? void 0 : users.length) ? /* @__PURE__ */ jsx(ProfileResults, { users: users.slice(0, 5), showMore: true }) : null
  ] });
}
function TrackResults({ tracks, showMore }) {
  return /* @__PURE__ */ jsxs("div", { className: "py-24", children: [
    ...
    /* @__PURE__ */ jsx(TrackTable, { tracks })
  ] });
}
function ArtistResults({ artists, showMore }) {
  return /* @__PURE__ */ jsxs("div", { className: "py-24", children: [
    /* @__PURE__ */ jsx(PanelTitle, { to: showMore ? "artists" : void 0, children: /* @__PURE__ */ jsx(Trans, { message: "Artists" }) }),
    /* @__PURE__ */ jsx(ContentGrid, { children: artists.map((artist) => /* @__PURE__ */ jsx(ArtistGridItem, { artist }, artist.id)) })
  ] });
}
function AlbumResults({ albums, showMore }) {
  return /* @__PURE__ */ jsxs("div", { className: "py-24", children: [
    /* @__PURE__ */ jsx(PanelTitle, { to: showMore ? "albums" : void 0, children: /* @__PURE__ */ jsx(Trans, { message: "Albums" }) }),
    /* @__PURE__ */ jsx(ContentGrid, { children: albums.map((album) => /* @__PURE__ */ jsx(AlbumGridItem, { album }, album.id)) })
  ] });
}
function PlaylistResults({ playlists, showMore }) {
  return /* @__PURE__ */ jsxs("div", { className: "py-24", children: [
    /* @__PURE__ */ jsx(PanelTitle, { to: showMore ? "playlists" : void 0, children: /* @__PURE__ */ jsx(Trans, { message: "Playlists" }) }),
    /* @__PURE__ */ jsx(ContentGrid, { children: playlists.map((album) => /* @__PURE__ */ jsx(PlaylistGridItem, { playlist: album }, album.id)) })
  ] });
}
function ProfileResults({ users, showMore }) {
  return /* @__PURE__ */ jsxs("div", { className: "py-24", children: [
    /* @__PURE__ */ jsx(PanelTitle, { to: showMore ? "users" : void 0, children: /* @__PURE__ */ jsx(Trans, { message: "Profiles" }) }),
    /* @__PURE__ */ jsx(ContentGrid, { children: users.map((user) => /* @__PURE__ */ jsx(UserGridItem, { user }, user.id)) })
  ] });
}
function PanelTitle({ children, to }) {
  return /* @__PURE__ */ jsx("h2", { className: "mb-24 w-max text-2xl font-medium", children: to ? /* @__PURE__ */ jsxs(Link, { to, className: "flex items-center gap-2 hover:text-primary", children: [
    children,
    /* @__PURE__ */ jsx(KeyboardArrowRightIcon, { className: "mt-4" })
  ] }) : children });
}
...
//# sourceMappingURL=web-player-routes-d8ccbd0f.mjs.map
