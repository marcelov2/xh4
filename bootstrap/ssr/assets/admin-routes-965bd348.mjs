...
import { u as useSettings, C as CustomMenu, T as Trans, c as createSvgIcon, N as Navbar, I as IconButton, s as setInLocalStorage, a as useIsMobileMediaQuery, D as DialogTrigger, m as message, b as useNumberFormatter, S as SelectForwardRef, d as Item, K as KeyboardArrowDownIcon, e as useTrans, F as FormSelect, f as FormTextField, g as useDialogContext, h as Dialog, i as DialogHeader, j as DialogBody, k as Form$1, l as Checkbox, B as Button, n as TextField, o as SearchIcon, p as DialogFooter, q as Skeleton, r as CloseIcon, t as opacityAnimation, P as ProgressBar, v as StaticPageTitle, w as queryClient, x as toast, y as showHttpErrorToast, z as apiClient, A as ConfirmationDialog, E as IllustratedMessage, G as SvgImage, H as onFormQueryError, J as CheckIcon, L as Chip, M as FormattedDate, O as Tooltip, Q as LoginIcon, R as FormImageSelector, U as useValueLists, V as DoneAllIcon, W as List, X as ListItem, Y as createSvgIconFromTree, Z as Section, _ as ButtonBase, $ as getInputFieldClassNames, a0 as MixedText, a1 as FileUploadProvider, a2 as useAppearanceEditorMode, a3 as ProgressCircle, a4 as useNavigate$1, a5 as useBootstrapData, a6 as FullPageLoader, a7 as LinkStyle, a8 as SiteConfigContext, a9 as getBootstrapData, aa as ExternalLink, ab as MenuTrigger, ac as Menu, ad as FormRadioGroup, ae as FormRadio, af as DateFormatPresets, ag as prettyBytes, ah as useSocialLogin, ai as useField, aj as Field, ak as useResendVerificationEmail, al as useUser, am as useUploadAvatar, an as useRemoveAvatar, ao as isAbsoluteUrl, ap as useMediaQuery, aq as useProducts, ar as FormattedPrice, as as SmallArtistImage, at as ArtistLink, au as PageStatus, av as TwitterIcon, aw as FacebookIcon, ax as UserProfileLink, ay as FormattedRelativeTime, az as useSelectedLocale, aA as slugifyString, aB as ComboBoxForwardRef, aC as WarningIcon, aD as useActiveUpload, aE as UploadInputType, aF as Disk, aG as useCustomPage, aH as PageMetaTags, aI as useCollator, aJ as loadFonts, aK as AuthRoute, aL as NotFoundPage } from "../server-entry.mjs";
import { D as DashboardLayoutContext, a as DashboardLayout, b as DashboardSidenav, c as DashboardContent, h as hasNextPage, u as useBackendFilterUrlParams, B as BackendFiltersUrlKey, d as downloadFileFromUrl, N as NameWithAvatar, e as usePrevious, F as FormSlider, U as USER_MODEL, M as MoreVertIcon, f as artistPageTabs, I as ImageZoomDialog, P as PauseIcon, A as ARTIST_MODEL, T as TRACK_MODEL, G as GenreLink, g as PLAYLIST_MODEL, C as CreatePlaylistDialog, i as PlaylistLink, j as UpdatePlaylistDialog, k as useDeleteComments, l as TrendingUpIcon, m as CHANNEL_MODEL, n as GridViewIcon, o as ImageIcon, p as useIsTouchDevice, E as EMPTY_PAGINATION_RESPONSE, q as useChannel } from "./use-channel-c8660ecc.mjs";
...
import { K as KeyboardArrowLeftIcon, a as KeyboardArrowRightIcon, F as FormattedNumber, A as Avatar, T as Table, b as AddIcon, c as FormSwitch, C as ChipList, S as Switch, u as useSortable, t as themeValueToHex, D as DragPreview, m as moveItemInNewArray, d as Tabs, e as TabList, f as Tab, g as TabPanels, h as TabPanel, i as TrackImage, j as TrackLink, k as FormattedDuration, l as AlbumImage, n as AlbumLink, o as ALBUM_MODEL, U as UserAvatar, G as GENRE_MODEL, p as TableContext } from "./play-arrow-filled-d45cea03.mjs";
...
import { B as Breadcrumb, a as BreadcrumbItem, C as ChevronRightIcon, u as useCancelSubscription, b as useResumeSubscription } from "./use-resume-subscription-cddb206a.mjs";
...
const IconList = React.lazy(() => import("./icon-list-c91f8713.mjs"));
...
function LandingPageSectionGeneral() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "my-24 py-24 border-y", children: [
      /* @__PURE__ */ jsx(
        AppearanceButton,
        {
          to: "action-buttons",
...
function HeaderSection() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "text-muted text-xs mb-20", children: /* @__PURE__ */ jsx(Trans, { message: "In order for overlay colors to appear, header image opacity will need to be less then 100%" }) }),
    /* @__PURE__ */ jsx(
...
function PricingSection() {
  return /* @__PURE__ */ jsxs("div", { className: "mt-24 pt-24 border-t", children: [
    /* @__PURE__ */ jsx(
      FormTextField,
      {
...
const AceEditor = React.lazy(() => import("./ace-editor-616810f9.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function ArtistPagePanel() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: "text-sm mb-14", children: [
...
const TabDragPreview = React.forwardRef(
  ({ title }, ref) => {
    return /* @__PURE__ */ jsx(DragPreview, { ref, children: () => /* @__PURE__ */ jsx("div", { className: "p-8 rounded shadow bg-chip text-sm", children: title }) });
  }
);
...
function MailNotSetupWarning() {
  ...
  if (mailSetup)
    return null;
  return /* @__PURE__ */ jsx("p", { className: "mt-10 text-danger", children: /* @__PURE__ */ jsx(
    Trans,
    {
...
const Indent = Extension.create({
  ...
  addCommands() {
    const setNodeIndentMarkup = (tr, pos, delta) => {
      var _a2;
      const node = (_a2 = tr == null ? void 0 : tr.doc) == null ? void 0 : _a2.nodeAt(pos);
      if (node) {
  ...
  return /* @__PURE__ */ jsxs(
    Form$1,
    {
      ...
      onSubmit: (values) => {
        onSubmit({
          ...values,
          text: (editor == null ? void 0 : editor.getHTML()) || ""
        });
      },
      children: [
        /* @__PURE__ */ jsx(
        ...
        editor && /* @__PURE__ */ jsx("div", { className: "rounded border", children: /* @__PURE__ */ jsxs(FileUploadProvider, { children: [
          /* @__PURE__ */ jsx(EditorMenu, { editor }),
          /* @__PURE__ */ jsx("div", { className: "p-14", children: /* @__PURE__ */ jsx(EditorContent, { editor }) })
        ] }) })
      ]
    }
  );
...
function EditorMenu({ editor }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex h-42 items-center overflow-hidden border-b px-4 text-muted", children: [
    /* @__PURE__ */ jsx(FontStyleButtons, { editor, size: "sm" }),
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsx(AlignButtons, { editor, size: "sm" }),
    /* @__PURE__ */ jsx(IndentButtons, { editor, size: "sm" }),
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsx(ListButtons, { editor, size: "sm" }),
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsx(ColorButtons, { editor, size: "sm" }),
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsx(ClearFormatButton, { editor, size: "sm" })
  ] });
}
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-c5519da2.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-da553b8e.mjs"));
...
export {
  ...
  iconGridStyle as _,
  BarChartIcon as a,
  ClosedCaptionIcon as b,
  CodeIcon as c,
  DragIndicatorIcon as d,
  FilterAltIcon as e,
  FormatAlignCenterIcon as f,
  FormatAlignJustifyIcon as g,
  FormatAlignLeftIcon as h,
  FormatAlignRightIcon as i,
  FormatBoldIcon as j,
  FormatClearIcon as k,
  FormatColorFillIcon as l,
  FormatColorTextIcon as m,
  FormatIndentDecreaseIcon as n,
  FormatIndentIncreaseIcon as o,
  FormatItalicIcon as p,
  FormatListBulletedIcon as q,
  FormatListNumberedIcon as r,
  FormatUnderlinedIcon as s,
  PlayArrowIcon as t,
  useAdminReport as u,
  PriorityHighIcon as v,
  PublishIcon as w,
  RefreshIcon as x,
  ReportIcon as y,
  RestartAltIcon as z
};
//# sourceMappingURL=admin-routes-965bd348.mjs.map
